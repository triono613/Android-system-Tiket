        ...
        btn_continue.setOnClickListener(v -> {
            ...
            switch (sessionIntentFlag.trim()){
                ...
                case "flagPesanKarcisWisatawan":
                    ...
                    a.putExtra("result_flag_pesan_karcis_sukses", "sukses");
                    startActivity(a);
                    break;
...
//                sessionManager.logout();
                ...
                if ("checkQuotaTwa".equals(sessionIntentFlag.trim())) {
                    Intent a = new Intent(SuccessRegistrasiWisatawanActivity.this, PesanKarcisWisatawanOldActivity.class);
...
//                    _txt_tgl_kunjungan_order.setFocusableInTouchMode(true);
                ...
                else if ("checkQuotaTwaOk".equals(sessionIntentFlag.trim())){
                    Intent a = new Intent(SuccessRegistrasiWisatawanActivity.this, PesanKarcisWisatawanActivity.class);
                    startActivity(a);
                }
