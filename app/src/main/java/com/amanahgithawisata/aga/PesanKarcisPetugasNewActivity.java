...
public class PesanKarcisPetugasNewActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
...
//        _txt_tgl_kunjungan_order.clearComposingText();
        ...
        _spinner_lok_pintu_ptgs = (Spinner) findViewById(R.id.spinner_lok_pintu_ptgs_new);
        _spinner_karcis_utama_ptgs = (Spinner) findViewById(R.id.spinner_karcis_utama_ptgs_new);
        _spinner_karcis_tmbhn_ptgs  = (Spinner) findViewById(R.id.spinner_karcis_tmbhn_ptgs_new);;
        _text_quota = (TextView) findViewById(R.id.text_quota_new);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pesan_karcis_petugas_new);
        sessionManager = new SessionManager(getApplicationContext());
        findViewById(R.id.loadingPanel).setVisibility(View.GONE);

        _tgl_kunjungan_ptgs = (TextView) findViewById(R.id.tgl_kunjungan_ptgs_new);
        _spinner_lok_pintu_ptgs = (Spinner) findViewById(R.id.spinner_lok_pintu_ptgs_new);
        _spinner_karcis_utama_ptgs = (Spinner) findViewById(R.id.spinner_karcis_utama_ptgs_new);
        _spinner_karcis_tmbhn_ptgs =(Spinner) findViewById(R.id.spinner_karcis_tmbhn_ptgs_new);
        _spinner_jns_byr_ptgs = (Spinner) findViewById(R.id.spinner_jns_byr_ptgs_new);
        _jml_krcs_wisnu_ptgs = (EditText) findViewById(R.id.jml_krcs_wisnu_ptgs_new);
        _jml_krcs_wisman_ptgs = (EditText) findViewById(R.id.jml_krcs_wisman_ptgs_new);
        _jml_krcs_wisman_tmbhn_ptgs = (EditText) findViewById(R.id.jml_krcs_wisman_tmbhn_ptgs_new);
        _ttl_ptgs = (EditText) findViewById(R.id.ttl_ptgs_new);
        _ttl_tmbhn_ptgs = (EditText) findViewById(R.id.ttl_tmbhn_ptgs_new);
        _grand_ttl_ptgs = (EditText) findViewById(R.id.grand_ttl_ptgs_new);
        _btn_order_ptgs = (Button) findViewById(R.id.btn_order_ptgs_new);
        _hp_pengunjung_ptgs = (TextView) findViewById(R.id.hp_pengunjung_ptgs_new);
        _email_pengunjung = (TextView) findViewById(R.id.email_pengunjung_ptgs_new);
        _nama_pengunjung_ptgs = (TextView) findViewById(R.id.nama_pengunjung_ptgs_new);
...
//                CalculateKarcis();
    ...
    public void CalculateKarcis(){
        final double _jml_krcs_wisnu = Help.ParseDouble(((EditText) findViewById(R.id.jml_krcs_wisnu_ptgs_new)).getText().toString());
        final double _jml_krcs_wisman = Help.ParseDouble(((EditText) findViewById(R.id.jml_krcs_wisman_ptgs_new)).getText().toString());
        final double _jml_krcs_tmbhn = Help.ParseDouble(((EditText) findViewById(R.id.jml_krcs_wisman_tmbhn_ptgs_new)).getText().toString());
...
//                                        Toast.makeText(PesanKarcisPetugasActivity.this,"quota > 0.", Toast.LENGTH_LONG).show();
                                ...
                                TextView quotax = (TextView)findViewById(R.id.text_quota_new);
