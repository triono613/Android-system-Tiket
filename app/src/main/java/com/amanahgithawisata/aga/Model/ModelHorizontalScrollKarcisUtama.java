...
public class ModelHorizontalScrollKarcisUtama {

    public String url_ku;
    ...
    public String result_dt_harga_karcis_wisata_tmbhn;
    ...
    public ModelHorizontalScrollKarcisUtama(String url_ku,
        ...
        this.result_dt_harga_karcis_wisata_tmbhn = result_dt_harga_karcis_wisata_tmbhn;
    ...
    public String getResult_dt_harga_karcis_wisata_tmbhn() {
        return result_dt_harga_karcis_wisata_tmbhn;
    }

    public void setResult_dt_harga_karcis_wisata_tmbhn(String result_dt_harga_karcis_wisata_tmbhn) {
        this.result_dt_harga_karcis_wisata_tmbhn = result_dt_harga_karcis_wisata_tmbhn;
    }
}
