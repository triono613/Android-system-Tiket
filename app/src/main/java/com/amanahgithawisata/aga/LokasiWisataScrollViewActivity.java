...
public class LokasiWisataScrollViewActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener  {
    TextView _txt_tgl_kunjungan_order;
    TextView _txt_jml_krcs_wisnu;
    TextView _txt_jml_krcs_wisman;
    TextView _txt_ttl;
    TextView _txt_jml_krcs_tmbhn;
    TextView _txt_ttl_tmbhn;
    TextView _txt_grand_ttl;
    Spinner _spiner_lok_wis_wstwn_order;
...
//    AdapterPagerLokasiWisata _adapter_1 = new AdapterPagerLokasiWisata();
//    CustomAdapterViewPagerLokasiPintu _adapter_2 = new CustomAdapterViewPagerLokasiPintu();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lokasi_wisata_scroll_view);
        ...
        View inflatedView = getLayoutInflater().inflate(R.layout.card_lokasi_wisata, null);
        Button _btnHx = (Button) inflatedView.findViewById(R.id.buttonH);


        spinnerLokWisata("daftar_lokasi_wisata");
        horizontalLokasiWisata("daftar_lokasi_wisata");

//        horizontalLokasiPintu("daftar_lokasi_pintu","",getApplicationContext());
...
//        _txt_tgl_kunjungan_order.performClick();
        ...
        _btnHx.setOnClickListener(v -> {
            final String KSDA = sessionManager.getDataLokWisPesankarcisWisatawanKsda().get(SessionManager.key_kd_ksda);
            Log.e("","ksda btnH "+KSDA);
        ...
        _spiner_krc_tmbhn_wstwn_order.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                sessionManager = new SessionManager(getApplicationContext());
                sessionManager.createSessionWisTmbhn(   item.getKode_karcis(), item.getNama_karcis(), item.getHarga_karcis_wisata(),item.getId_tmbhn(),"" );
                CalculateKarcis();
            }
        ...
        pagerViewLokasiWisata = findViewById(R.id.pagerLokasiWisataScroll);
        pagerViewLokasiPintu = findViewById(R.id.pagerLokasiPintu);
//        isiViewPager();
    ...
    private void isiViewPager() {
        ...
        CustomAdapterViewPagerLokasiWisata adapter = new CustomAdapterViewPagerLokasiWisata();
        b.setText(""+judul.length);
        for (int i=0;i<judul.length;i++){
//            adapter.addCardItem(new ModelHorizontalScrollLokasiWisata(judul[i], text[i], gambar[i]));
        }

        adapter.addCardItem(new ModelHorizontalScrollLokasiWisata("Gunung Pangrango",
                "gunung pangrango adalah bagian dari gugusan pegunungan ",
                "a"));
        adapter.addCardItem(new ModelHorizontalScrollLokasiWisata("Gunung Salak",
                "gunung pangrango adalah bagian dari gugusan pegunungan ",
                "b"));
        adapter.addCardItem(new ModelHorizontalScrollLokasiWisata("Gunung Batu",
                "gunung pangrango adalah bagian dari gugusan pegunungan ",
                "c"));

        pagerViewLokasiWisata.setAdapter(adapter);
                        ...
                        if( Help.isJSONValid(response) ){
                            ...
                            if( jsonObject.getBoolean("success") ) {
                                ...
                                for (int i = 0; i <jsonArray.length();i++ ) {
                                    ...
                                    almt_lokasi = jsonObject1.getString("alamat");
                                    kota_lokasi = jsonObject1.getString("kota");
                                    url_lokasi = jsonObject1.getString("url_image");
...
//                                    kd_ksda = jsonObject1.getString("kode_ksda");
                                    ...
                                    lokWisList.add(new SpinnerListWisata(kd_lokasi,nm_obj_wisata,almt_lokasi,kota_lokasi,url_lokasi));

//                                    _adapter_1.addCardItem(new ModelHorizontalScrollLokasiWisata(kd_lokasi,
//                                            nm_obj_wisata,
//                                            " "));
                                }
                            }
...
//                        pagerViewLokasiWisata.setAdapter(_adapter_1);
//                        pagerViewLokasiWisata.setOffscreenPageLimit(3);
//                        pagerViewLokasiWisata.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
...
//                        });
            ...
            requestQueue.stop();
            findViewById(R.id.loadingPanel).setVisibility(View.GONE);
            AlertDialog.Builder builder = new AlertDialog.Builder(LokasiWisataScrollViewActivity.this);
...
//                                    _adapter_2.addCardItem(new ModelHorizontalScrollLokasiPintu(kd_lokasi,
//                                            nm_obj_wisata,
//                                            " "));
                                }
                            }
...
//                        _adapter_2.addCardItem(new ModelHorizontalScrollLokasiPintu("Gunung Pangrango",
//                                "gunung pangrango adalah bagian dari gugusan pegunungan ",
//                                "a"));
//                        _adapter_2.addCardItem(new ModelHorizontalScrollLokasiPintu("Gunung Salak",
//                                "gunung pangrango adalah bagian dari gugusan pegunungan ",
//                                "b"));
//                        _adapter_2.addCardItem(new ModelHorizontalScrollLokasiPintu("Gunung Batu",
//                                "gunung pangrango adalah bagian dari gugusan pegunungan ",
//                                "c"));

//                        pagerViewLokasiPintu.setAdapter(_adapter_2);
//                        pagerViewLokasiPintu.setOffscreenPageLimit(3);
//                        pagerViewLokasiPintu.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
//                            @Override
//                            public void onPageScrolled(int i, float v, int i1) {
//
//                            }
...
//                        });
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                Map<String, String> obj = new HashMap<String, String>();
//                    final String KSDA = sessionManager.getDataLokWisPesankarcisWisatawanKsda().get(SessionManager.key_kd_ksda);
//                final String KSDA = sessionManager.getDataHorizontalPintu().get(SessionManager.key_kd_ksda_horz_1);
//                Log.e("","KSDA= "+KSDA);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                response -> {
                    ...
                    try {
                        ...
                        _spinner_lok_wis.setAdapter(new ArrayAdapter<SpinnerListWisataKsda>(LokasiWisataScrollViewActivity.this, android.R.layout.simple_spinner_dropdown_item,lokWisListKsda) );
                    } catch (JSONException e) {
                        ...
                        if( Help.isJSONValid(response) ){
                            ...
                            if( jsonObject.getBoolean("success") ) {
                                ...
                                for (int i = 0; i <jsonArray.length();i++ ) {
                                    ...
                                    String kd_lokasi = jsonObject1.getString("kode_ksda");
                                    String almt_lokasi = jsonObject1.getString("alamat");
                                    String kota_lokasi = jsonObject1.getString("kota");
                                    String url_lokasi = jsonObject1.getString("url_image");
...
//                                    kd_ksda = jsonObject1.getString("kode_ksda");
                        ...
                        _spiner_lok_wis_wstwn_order.setAdapter(new ArrayAdapter<SpinnerListWisata>(LokasiWisataScrollViewActivity.this, android.R.layout.simple_spinner_dropdown_item,lokWisList) );
                    } catch (JSONException e) {
                        Log.i("", "error ===" + e.toString() );
                        e.printStackTrace();
                    }
        ...
        StringRequest stringRequest_s2 = new StringRequest(Request.Method.POST, server_url_s2,
                (Response.Listener<String>) response -> {
                    ...
                    try {
                        ...
                        _spiner_krc_utm_wstwn_order.setAdapter(new ArrayAdapter<SpinnerKarcisUtama>(LokasiWisataScrollViewActivity.this, android.R.layout.simple_spinner_item,arrKarcisUtama) );
                    } catch (JSONException e) {
                        Log.i("triono", "error ===" + e.toString() );
                        e.printStackTrace();
                    }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            _spiner_krc_tmbhn_wstwn_order.setAdapter(new ArrayAdapter<SpinnerKarcisTambahan>(LokasiWisataScrollViewActivity.this, android.R.layout.simple_spinner_dropdown_item,arrKarcisTambahan) );
                        } catch (JSONException e) {
                            Log.i("", "error ===" + e.toString() );
                            e.printStackTrace();
                        }
                        ...
                        try {
                            ...
                            if( Help.isJSONValid(response) ){
                                ...
                                if( berhasil ) {
                                    ...
                                    Intent i = new Intent(LokasiWisataScrollViewActivity.this, SuccessRegistrasiWisatawanActivity.class);
