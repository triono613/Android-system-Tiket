...
//                    changePassword("ubah_kata_kunci");
    ...
    private void validasi(){
        ...
        if(TextUtils.isEmpty(__text_pass_baru_ep) || __text_pass_baru_ep.length() < 8 ) {
            ...
            Toast.makeText(getApplicationContext(),"Password Masih Kosong || Password Min 8 Char!",Toast.LENGTH_LONG).show();
        }
    ...
    public void changePassword(String EP){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                new Response.Listener<String>() {
                    ...
                    requestQueue.stop();
                    findViewById(R.id.loadingPanel).setVisibility(View.GONE);
                    AlertDialog.Builder builder = new AlertDialog.Builder(EditPasswordPetugasActivity.this);
