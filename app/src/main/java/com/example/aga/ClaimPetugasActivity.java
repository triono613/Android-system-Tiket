...
import com.example.aga.Model.SpinnerJnsClaim;
...
//                                                sessionManager.logout();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                Map<String, String> obj = new HashMap<String, String>();
                final String registration_by = sessionManager.getUserDetail().get(SessionManager.key_email);
                final String va_no = _no_va.getText().toString();
                final String kontak_pelapor = _text_contact_pelapor.getText().toString();
                final String nama_pengunjung = _text_nama_pengunjung.getText().toString();
                final String kontak_pengunjung = _text_contact_pengunjung.getText().toString();
                final String jenis_klaim = sessionManager.getDataJnsClaim().get(SessionManager.key_jns_claim);
                final String nominal_klaim = _text_nom_claim.getText().toString();
                final String keterangan_klaim = _text_ket_claim.getText().toString();
                final String tgl_kejadian = _tgl_kejadian.getText().toString();
                final String lokasi_kejadian = _text_lokasi_kejadian.getText().toString();
